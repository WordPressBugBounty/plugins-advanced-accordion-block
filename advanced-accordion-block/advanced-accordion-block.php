...
/**
 * Allows SVG file uploads in WordPress.
 *
 * Adds SVG to the list of allowed MIME types.
 *
 * @param array $mimes Existing MIME types.
 *
 * @return array Updated MIME types with SVG support.
 */
if ( !function_exists( 'aab_custom_svg_uploads' ) ) {
    function aab_custom_svg_uploads(  $mimes  ) {
        $mimes['svg'] = 'image/svg+xml';
        return $mimes;
    }

}
add_filter( 'upload_mimes', 'aab_custom_svg_uploads' );